                ...
                <div className="flex rounded-3xl shadow-xl bg-white w-1/2 h-1/2 items-center space-x-4">
                    ...
                    {isLogin && (
                        <form onSubmit={handleLogin} className="flex flex-col gap-3  w-1/2 px-10">
                            ...
                            <button className="text-black border border-gray-400 rounded-lg px-6 py-3">
                    ...
                    {isLogin ? (
                        <div className="w-1/2 flex flex-col justify-center items-center bg-blue-400 h-full rounded-bl-5xl">
                            <p className="text-white text-lg font-bold flex flex-col">Don't Have an Account Yet?
                                <span className="text-xs font-light">Let's get you all set up so you can start it up</span>
                            </p>
                            <button
                                type="button"
                                onClick={() => {
                        ...
                        <div className="flex bg-white w-full h-full items-center space-x-4">
                            ...
                            <div className="w-1/2 flex flex-col justify-center items-center  bg-blue-400 h-full rounded-br-5xl">
                                <p className="text-white text-lg font-bold flex flex-col items-center">Already Signed up?
                                    <span className="text-xs font-light ">Sign in to your account so you can continue </span>
                                </p>
                                <button
                                    type="button"
                                    onClick={() => {
                            ...
                            <form onSubmit={handleSignUp} className="flex flex-col gap-3  w-1/2 px-10">
                                {responseMessage && (
                                    <div className={`p-3 rounded-md mb-2 ${responseMessage.includes("Error")
                                        || responseMessage.includes("Invalid") ? "bg-red-400" : "bg-green-400"} text-white`}>
                                        {responseMessage}
                                    </div>
                                )}
