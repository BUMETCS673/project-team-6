        ...
        <div className="relative flex flex-row justify-between items-center mx-auto z-20 bg-white">
          ...
          <div className="w-1/2">
            <p className="w-8/12 translate-y-10 translate-x-35 px-14 text-black text-end">
              Join our founders as they share the passion, journey, and vision
              behind RentalCompany. Learn how we&apos;re reshaping the rental
              landscape and why we&apos;re confident in delivering an
              unparalleled experience to our community.
            </p>
          </div>
