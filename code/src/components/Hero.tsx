...
export default function Hero({
  ...
  return (
    <>
      ...
      >
        <div className="w-full sm:w-1/2 md:w-3/5 lg:w-3/5 px-4 sm:px-14 text-xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl -translate-y-10 sm:-translate-y-40">
        ...
        <div className="relative sm:absolute bottom-0 left-0 right-0 transform w-full bg-black z-20">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-75 w-2/12 z-20">
            <Image
              src="/StartButton.svg"
              alt="Start Button"
          ...
          <Image
            src="/Divider.svg"
            alt="Divider"
            className="absolute xl:-translate-y-30 sm:-translate-y-50 w-full z-20"
            ref={imageRef}
            width={1326}
            height={306}
          />
        ...
        <div className="w-full sm:w-1/2 md:w-2/5 lg:w-1/4 flex justify-center sm:justify-end items-center z-10 mt-8 sm:mt-0">
