...
export default function Home() {
  ...
  const [imageDimensions, setImageDimensions] = useState<{ height: number, width: number }>({ height: 0, width: 0 });
  ...
  const squares_1 = [
    {
      header: "Protection",
      icon: <Image src="/favicon.svg" alt="Protection Icon" className="w-10" width={80} height={80}/>,
      text: "Data Protection guarantees",
    },
    {
      header: "Tracking",
      icon: <Image src="/favicon.svg" alt="Tracking Icon" className="w-10" width={80} height={80}/>,
      text: "Track all your financial transactions ",
    },
    {
      header: "Flexibility",
      icon: <Image src="/favicon.svg" alt="Flexibility Icon" className="w-10" width={80} height={80}/>,
      text: "Delivery through multiple channels",
    },
    {
      header: "Easiness",
      icon: <Image src="/favicon.svg" alt="Easiness Icon" className="w-10" width={80} height={80}/>,
      ...
      <div className="bg-white min-h-full w-full">
        ...
        <nav className="fixed top-0 w-full flex justify-between items-center px-4 py-10 bg-gradient-to-b from-black to-transparent z-40">
          <div className="flex justify-start items-center sm:w-1/3 px-12">
              ...
              ><Image src="/CompanyLogo.svg" alt="Company Logo" width={244.59} height={23.84} /></a>
          </div>
          ...
          <div className="px-10 flex justify-end items-center sm:w-1/3">
              <Link href="/signin" className="bg-custom-orange text-white hover:bg-custom-hover-orange transition duration-800 px-4 ease-in-out rounded-3xl py-2 sm:py-4 sm:px-8">
        ...
        {/* Hero */}
        <section id='home' className="relative w-full text-white bg-black mx-auto flex flex-col sm:flex-row justify-between items-center pb-10 pt-20">
            ...
            <div className="relative sm:absolute bottom-0 left-0 right-0 transform w-full bg-black z-20">
              ...
              {/* Car cards in the center */}
              <Image src="/Divider.svg" alt="Divider" className="absolute -translate-y-30 w-full z-20" ref={imageRef} width={1326} height={306}/>
            </div>
            ...
            <div className="w-full sm:w-1/2 flex justify-center sm:justify-end items-center z-10 mt-8 sm:mt-0">
                ...
                <Image src="/carImage.png" alt="Car Image" className="w-1/2 sm:w-213 h-auto sm:h-160" width={426} height={320} />
            </div>
            ...
            <div style={{ height: imageDimensions?.height }} className={`absolute w-full translate-y-90 bg-black z-0`}></div>
        </section>


        {/* Body Sections */}
        {/* Section 1 */}
        <section id='features' className="relative flex flex-row justify-between mx-auto pt-20 mt-20 z-30 bg-white">
          <div className="w-1/2">
        ...
        <section id='about' className="relative flex flex-col z-30 bg-white">
          <div className="relative flex flex-row justify-between mx-auto z-20 bg-white">
            <div className="w-1/2">
              <div className="w-1/2 -translate-y-40 translate-x-20 px-14">
                <Image src="/02.svg" alt="02" className="w-80" width={251} height={248}/>
              </div>
              <h1 className="w-10/12 -translate-y-65 translate-x-35 px-14 text-5xl">Learn more about <span className="font-bold">RentalCompany</span></h1>
            </div>
            <div className="w-1/2">
            ...
            {squares_2.map((item, index) => (
              <div
                ...
                className={`flex flex-col justify-center items-center rounded-lg w-1/3 h-40 ${
                  index == 0 ? 'bg-custom-light-grey text-text-grey' 
                  : index == 1 ? `bg-custom-light-grey text-custom-grey`
        ...
        <section className="relative flex justify-center items-center bg-white pt-20 pb-10">
          <div className="w-9/12 flex flex-row items-center rounded-7xl mx-40 py-10 bg-black text-white z-30">
            ...
            <div className="w-7/12 flex justify-end items-center pr-4 z-10">
              <Image src="/CarFloating.svg" alt="Car Floating" className="w-158 h-115" width={782} height={573}/>
            </div>
          </div>
        </section>
          ...
          <div className="relative flex flex-row justify-between mx-auto z-20 bg-white">
            <div className="w-1/2">
              <div className="w-1/2 translate-x-20 px-14">
                <Image src="/03.svg" alt="03" className="w-80" width={251} height={248} />
              </div>
              <h1 className="w-10/12 -translate-y-20 translate-x-35 px-14 text-5xl">Hear from the founders of <span className="font-bold">RentalCompany</span></h1>
            </div>
            <div className="w-1/2">
        ...
        <footer className="relative flex flex-col justify-center items-center gap-20 rounded-t-7xl bg-black text-white z-30 p-6 mx-14">
          <div className="w-5/12 mb-4 justify-center items-center pt-10 text-center">
            <p className="text-5xl">Lorem ipsum dolor sit amet, adipiscing elit.</p>
          </div>
          ...
          <Image src="/CompanyLogo.svg" alt="Company Logo" width={366} height={36} />
          <div className="w-full flex flex-row justify-evenly items-center">
            <p className="w-1/3 text-sm text-center text-custom-grey">Terms & Agreements</p>
            <p className="w-1/3 text-sm text-center text-custom-grey">@2023 RentalCompany All Rights Reserved</p>
            <p className="w-1/3 text-sm text-center text-custom-grey">Privacy Policy</p>
          </div>
        </footer>
      </div>
    </>
