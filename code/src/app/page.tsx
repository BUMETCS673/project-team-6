  ...
  return (
    <>
      <div className="bg-black min-h-screen w-full">
        {/* Top Bar */}
        <nav className="fixed top-0 w-full container mx-auto flex justify-between items-center px-4 py-10 bg-gradient-to-b from-black to-transparent z-40">
          <div className="px-10">
              <Image src="/CompanyLogo.svg" alt="Company Logo" className="w-62" width={244.59} height={23.84}/>
          </div>
        ...
        {/* Hero */}
        <section className="relative container text-white bg-black mx-auto flex justify-between items-center pb-20 pt-10">
        ...
        {/* Body Sections */}
        {/* Section 1 */}
        <section className="relative container flex flex-row justify-between mx-auto pt-20 mt-20 z-30 bg-white">
          <div className="w-1/2">
            ...
            <div className="w-8/12 flex flex-row justify-between items-center -translate-y-50 translate-x-35 px-14 gap-2">
              ...
              {[0, 1, 2, 3].map(index => (
                  <div
                      ...
                      className={`flex flex-col justify-center items-center rounded-lg w-40 h-40 ${
                          index === 1 ? 'bg-black text-white' : 'bg-custom-light-grey text-text-grey'
                      }`}
                  >
        ...
        {/* Section 2 */}
        <section className='relative container bg-white z-20'>
