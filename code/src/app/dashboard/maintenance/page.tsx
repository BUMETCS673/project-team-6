...
async function getMaintenanceInfo() {
  ...
  try {
    ...
    Object.keys(data).forEach((dateMaintenance) => {
      ...
      >
        {typeof scheduled === 'string' || scheduled instanceof String ? (
          ...
          <>
            ...
            <div className="pl-10 bg-red-600 text-white">
              Oil Maintenance Overdue
            </div>
            <div className="pl-10 bg-pink-500 text-white">
              Oil Maintenance Due
            </div>
            <div className="pl-10 bg-blue-900 text-white">
              Tire Maintenance Overdue
            </div>
            <div className="pl-10 bg-blue-400 text-white">
              Tire Maintenance Due
            </div>
          </>
        )}
      </div>
